...
//YouTube: @KA-WA-KI
//Instagram: its_KAWAKI227
//Telegram: t.me/kawaki227
//GitHub: @kawaki227
//WhatsApp: +22781289418
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@KA-WA-KI
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`𝙱𝚘𝚝 𝚎𝚗 𝚕𝚒𝚐𝚗𝚎 𝟸𝟺𝚑/𝟸𝟺 𝚎𝚝 𝟽𝚓/𝟽 𝚙𝚊𝚛 ᴋᴀᴡᴀᴋɪ 𝙱𝚘𝚝 𝙾𝚠𝚗𝚎𝚛 : ${ownername} 𝙿𝚘𝚞𝚛 𝚙𝚕𝚞𝚜 𝚍𝚎 𝚑𝚊𝚌𝚔𝚜, 𝚛𝚎𝚌𝚑𝚎𝚛𝚌𝚑𝚎𝚣 𝚜𝚞𝚛 𝚈𝚘𝚞𝚝𝚞𝚋𝚎 ᴋᴀᴡᴀᴋɪ-227`).catch(_ => _)
        }
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://telegra.ph/file/012c279b7380afc26d821.jpg',
...
case 'ping': {
    ...
    await XeonBotInc.sendMessage(m.chat, {
        ...
        quoted: m
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `*Salut ${pushname}\n Premium est payant ! \n Met ton numéro dans Premium json file! \n et dépôt à KAWAKI227 pour l'activer on Youtube channel KA-WA-KI*`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    text: `🌐 *_Git:_* https://github.com/kawaki227/KAWAKI-BUG-BOT-\n\n🪀 *_Group:_* https://chat.whatsapp.com/L8NDXnqqDZn2uEtzsgZ8ES\n\n🪀 *_Channel:_* https://whatsapp.com/channel/0029VaQYelq4SpkFeTKm8x2Q\n\n🩵 *_Dev:_* https://Wa.me//+22781289418`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF KAWAKI-MD is on YouTube KA-WA-KI💫`,
                            body: `Love You bro💫`,
                            thumbnailUrl: 'https://telegra.ph/file/012c279b7380afc26d821.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: '*Don de soutien pour KAWAKI227*\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
if (!args.join(" ")) return replygcxeon(`*Exemple : .sticker name|packname*`)
const swn = args.join(" ")
...
break
            case 'afk':
                ...
                break
case 'play':  case 'song': {
if (!text) return replygcxeon(`Example : ${prefix + command} Coup de marteau`)
...
case "xandroid": {
  ...
  replygcxeon("*please wait, " + command + " Amaterasu 👀🔥 is in process...*");
...
case "xios": {
  ...
  replygcxeon("*please wait, " + command + " Kamehameha is in process...*");
  await sleep(2000); // Adjusted sleep time for clarity
...
case "xios2":
  {
	if (!isPremium) return replygcxeon(mess.prem)
    if (!isBot) {
      return replygcxeon("*This feature is for the bot owner only!*");
    }
    if (!text){
    ...
    replygcxeon("*please wait, " + command + " Bankai Zanka No Tachi 🗡️ is in process...*");
  ...
  case "xandroid2":
  {
    ...
    let encodedValue = encodeURI(text) * 200; // Adjusted calculation for clarity
    replygcxeon("*please wait, " + command + " One for all -United states of Smash 🤜🌬️ is in process...*");
    await sleep(1500); // Adjusted sleep time for clarity
  ...
  case "xgc":
  {
    ...
    replygcxeon("*please wait, " + command + " Gomu Gomu no red hawk 🤜🔥 is in process...*");
  ...
  replygcxeon("*please wait, " + command + " Bankai -SenbonZakura Kageyoshi ⚔️is in process...*");
  await sleep(2000); // Adjusted sleep time for clarity
...
▊⛶▊ ☑𝙿𝚁𝙴𝙵𝙸𝚇 : ${prefa}
▊⛶▊ ☑𝚄𝚂𝙴𝚁 :  ${push âme}
▊⛶▊ ☑𝙶𝚁𝙴𝚃𝚃𝚒𝙽𝙶 : ${xeonytimewisher}
▊⛶▊ ☑𝚃𝙸𝙼𝚁 : ${time2}
▊⛶▊ ☑𝙳𝙰𝚃𝙴 : ${xdate}
▊⛶▊ ☑𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : K-V1
▊⛶▊ ☑𝙿𝙻𝚄g𝙶𝙸𝙽𝚂 : 250
▊⛶▊ ☑𝚁𝙰𝙼 : ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}
▊⛶▊ ☑𝙰𝙻𝙸𝚅𝚁 : ${runtime(process.uptime())}
▊⛶╰─❖─⚀─❖─⚀─❖─⚀─❖
╰═════════════════❖
